...
GRC isn't a checkbox exercise. It's the connective tissue between policy and reality. This repo is the knowledge base I wish I had when I started.
...
This variety makes it more challenging to come together as a community compared to software engineers to organize knowledge and share information. Our field is pretty new and has exponentially grown in the past five years.

Pull Requests are more than welcome! Nothing here is gospel, definitions are often subject to debates and heated discussions on LinkedIn and everyone has a different opinion on G, R and C (hatred for C is probably consensual IMHO).

> *This might include expert puns and boomer jokes*
...
| Encryption coverage (BitLocker/FileVault) | SOC2, ISO 27001, HIPAA data protection controls |
...
* [*Minimalist Risk Management*](https://github.com/magoo/minimalist-risk-management)
...
* [*Homelab Infrastructure*](https://github.com/mansudo/homelab-infrastructure)
  * Real-world VLAN layout, Intune CSP policies, and UniFi network topology from a 50+ endpoint homelab. Reference architecture for device compliance and network segmentation.

* [*Defender Hardening Playbook*](https://github.com/mansudo/defender-hardening-playbook)
  * CIS benchmark implementation, PowerShell audit scripts, and ASR rule configurations for Windows endpoint hardening.
